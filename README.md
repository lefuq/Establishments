Созданное в рамках практики приложение по созданию и редактированию заведений общественного питания, а так же блюд, продающихся в этих заведениях.
Стек технологий: Docker, Python 3.8, Django, PostgreSQL, django-rest, nginx, redis.
